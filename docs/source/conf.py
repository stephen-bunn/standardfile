...
htmlhelp_basename = "StandardFiledoc"
...
latex_documents = [
    (master_doc, "StandardFile.tex", "Standard File Documentation", author, "manual")
]
...
man_pages = [(master_doc, "standardfile", "Standard File Documentation", [author], 1)]
